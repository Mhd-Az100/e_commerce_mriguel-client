...
Future<Stream<Category>> getSubCategories(id) async {
  final String url =
      '${GlobalConfiguration().getString('api_base_url')}categories?with=subcategories&search=id:$id&searchFields=id:=&orderBy=id&sortedBy=desc&searchJoin=and';
