...
class SearchBarWidget extends StatelessWidget {
  ...
  const SearchBarWidget({Key key, this.onClickFilter,this.getLocation}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        padding: this.getLocation != null ? EdgeInsets.only(left: 5,right: 5) : EdgeInsets.all(10),
