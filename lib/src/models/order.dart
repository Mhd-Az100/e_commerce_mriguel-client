...
class Order {
  ...
  Order.fromJSON(Map<String, dynamic> jsonMap) {
    try {
      ...
      deliveryFee = jsonMap['delivery_fee'] != null
          ...
          : 0.0;
      cpDiscount = jsonMap['coupon_discount'] != null
  ...
  Map toMap() {
    ...
    map["tax"] = tax;
    map["delivery_fee"] = (deliveryFee - couponDiscountForDelivery);
    map["delivery_fee_discount"] = couponDiscountForDelivery;
