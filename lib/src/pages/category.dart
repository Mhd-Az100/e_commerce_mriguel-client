    ...
    scrollController.addListener(() {
      ...
      if (maxScroll - currentScroll <= delta) {
        if (_con.selectedCat == '-1')
          _con.listenForPaginateProducts(id: widget.routeArgument.id);
        else
          _con.listenForPaginateProductsBySub(id: _con.selectedCat);
      }
    });
    // _con.listenForSubCategories(widget.routeArgument.category);
