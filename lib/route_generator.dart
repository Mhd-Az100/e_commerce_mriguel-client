...
import 'src/pages/clic_to_pay.dart';
...
import 'src/pages/market_category.dart';
import 'src/pages/sub_product_category.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/MarketCategory':
        return MaterialPageRoute(
            builder: (_) =>
                MarketCategoryWidget(routeArgument: args as RouteArgument));
      case '/SubProductCategory':
        return MaterialPageRoute(
            builder: (_) =>
                SubProductCategoryWidget(routeArgument: args as RouteArgument));
      case '/Cart':
        return MaterialPageRoute(
      ...
      case '/ClicToPay':
        return MaterialPageRoute(builder: (_) => ClicToPay());
      case '/CashOnDelivery':
        return MaterialPageRoute(
      ...
      default:
        ...
        return MaterialPageRoute(builder: (_) => PagesWidget(currentTab: 1));
    }
  }
}
